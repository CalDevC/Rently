      ...
      <div>
        ...
        <div>
          <form onSubmit={this.submitHandler}>
            ...
            <br />
            <label>
              By clicking here you certify that you are at least 13 years of
              age.
            </label>
            <input type="checkbox" id="age" required />
            <br />
            <label>
              By clicking here you agree to the <a href="www.google.com">TOS</a>{" "}
              and the <a href="www.google.com">Privacy Policy</a>.
            </label>
